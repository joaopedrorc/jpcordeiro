...
<a
	href={step.href}
	target="_blank"
	class="p-4 sm-p-6 flex flex-col gap-4 rounded-lg border border-solid border-violet-700 text-center
gorup cursor-pointer hover:border-violet-400 duration-200"
>
	<div
		class="bg-slate-950 grid place-items-center px-4 text-5xl md:text-6xl -mt-10 sm:-mt-12 md:-mt14 lg:-mt-16 mx-auto duration-200"
	>
		<i class={step.icon}></i>
	</div>
	...
	<div class="flex-1 flex justify-between gap-4 items-center">
		...
		>
			<p class="relative p-4">Go to &rarr;</p>
		</div>
	</div>
</a>
