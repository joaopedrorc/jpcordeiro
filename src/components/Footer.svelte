...
>
	...
	<div class="flex flex-col gap-4 items-center justify-center">
		<p><b class="pr-2">Email</b> jpc5626@gmail.com</p>
		<p>
			<b class="pr-2">GitHub</b>
			<a href="https://github.com/joaopedrorc" target="_blank" class="text-violet-400">
				joaopedrorc
				<sup class="">
		...
		<p>
			...
			<a href="https://www.linkedin.com/in/joaopedrorc/" target="_blank" class="text-violet-400"
				>joaopedrorc<sup class=""
					><span class="text-xs scale-75 pl-0.5"
